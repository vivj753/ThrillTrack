...
String acti=request.getParameter("act");
%>
...
<head>
    ...
    <span class="location"><%=location %></span>
            ...
            <div class="nav-signin border ">
                <a  href="#"><p><span>Hello, <%=name %><br/>Your profile</span></p>
   ...
   <div class="container">
        ...
        con = DriverManager.getConnection("jdbc:mysql://localhost:3306/thrilltrack", "root", "vivek");
                ...
                String sql = "select * from Activities where ActivityTypeID in (select ActivityTypeID from activitytypes where type=?)";
                pstmt = con.prepareStatement(sql);
                pstmt.setString(1, acti);
...
<body>
    ...
    <% while(rs.next()) { %>
        <div class="blog-card">
            ...
            Difficulty: <%=rs.getString("DifficultyLevel") %></p>
        </div>
    <% } %>
    </main>
</body>
