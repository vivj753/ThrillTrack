...
<head>
    ...
    <link rel="Stylesheet" href="other_res/success.css">
    ...
    <body>
        <div id="centered">
            <div id="confirmation-container">
                ...
                <p id="confirmation-message">Your thrill has been booked successfully.</p><br>
                <p><a href="yourbookings.jsp" id="confirmation-button">Click here to go to Your Bookings</a></p><br>
            </div>
        </div>
    </body>
